...
export const paymentMethods = [
  { id: 'credit', label: 'Tarjeta de Crédito', description: 'Visa, Mastercard, American Express' },
  { id: 'debit', label: 'Tarjeta de Débito', description: 'Débito inmediato' },
  { id: 'transfer', label: 'Transferencia Bancaria', description: 'CBU o Alias' },
  { id: 'cash', label: 'Efectivo (Solo retiro)', description: 'Pago en tienda física' },
];
